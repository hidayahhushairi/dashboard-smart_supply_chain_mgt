...
Result revealed a positive correlation between order quantity and discount rate. Products that are sold in larger volumes such as Under Armour Girls' Toddler Spine Surge Running extremely high quantity (19,974) with high discount rate, tend to receive higher discount rates ($676.64), possibly due to bulk pricing strategies, promotions, or popularity driving aggressive pricing. Meanwhile, there are outliers like Toys ordered with moderate quantity (253) but with high discount rate ($25.77), proving that discount isn’t strictly tied to quantity and might also depend on seasonality, marketing pushes, or overstock clearance.
...
2. <img width="592" height="729" alt="image" src="https://github.com/user-attachments/assets/9b94e7b9-ef85-4d8f-8475-451a190d5e4e" /> <br>
    Table chart shows the fraudulent suppliers buying pattern. It includes the record of agent staffs name on duty, the supplier id, and how 
